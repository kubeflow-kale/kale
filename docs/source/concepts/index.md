...
- [](cell-types.md) — the full tag vocabulary
- [](data-passing.md) — how marshalling works and which types are supported
- [](compilation.md) — the exact compilation pipeline, file by file
